...
| [lesson-public-clone-path-stays-tracked.md](lesson-public-clone-path-stays-tracked.md) | Public clone how-to stays tracked; audit `*.example.*` content because a suffix is not sanitization; gitignore ≠ history scrub |
