...
| [lesson-smoke-privacy-allows-public-seeds.md](lesson-smoke-privacy-allows-public-seeds.md) | The public smoke guard must allow only named clone-safe seeds under private-shaped roots, never the whole root |
