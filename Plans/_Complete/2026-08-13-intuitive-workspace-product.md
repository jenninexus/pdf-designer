...
- [x] Archive the legacy `storage/` **payload duplicates** (2026-08-16) into `storage/_archive/`; keep the `storage/` directory as alias + private local material + private font. Do not delete the alias folder yet.
