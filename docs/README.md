...
| [`../layouts/resume/one-page-letter.json`](../layouts/resume/one-page-letter.json) | ⭐ **Cover-letter page model** — flowing sign-off, fit-to-one-page bands. NOT the résumé's pinned model (that clips a letter) |
...
`storage/` is **gitignored** — vaults, real brands, applications, fonts, images.
